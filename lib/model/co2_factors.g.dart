...
const carKey = 'car';
const car = Co2Factor(0.000193, 'Base Carbone ADEME > Voiture > 2018 > Motorisation moyenne');
...
const petrol = Co2Factor(0.00168, 'Base Carbone ADEME > Essence > E85');
const dieselKey = 'diesel';
const diesel = Co2Factor(0.00287, 'Base Carbone ADEME > Gazole > B30');
const lpgKey = 'lpg';
...
const paperWasteKey = 'paperWaste';
const paperWaste = Co2Factor(0.0431, 'Base Carbone ADEME > Papier > fin de vie moyenne');
const cardboardWasteKey = 'cardboardWaste';
const cardboardWaste = Co2Factor(0.0379, 'Base Carbone ADEME > Carton > fin de vie moyenne');
const mineralsWasteKey = 'mineralsWaste';
const mineralsWaste = Co2Factor(0.033, 'Base Carbone ADEME > Déchets minéraux > fin de vie moyenne');
const plasticWasteKey = 'plasticWaste';
const plasticWaste = Co2Factor(0.877, 'Base Carbone ADEME > Plastique moyen > fin de vie moyenne');
const householdWasteKey = 'householdWaste';
const householdWaste = Co2Factor(0.215, 'Base Carbone ADEME > Ordures ménagères > fin de vie moyenne');
const waterWasteKey = 'waterWaste';
const waterWaste = Co2Factor(0.000262, 'Base Carbone ADEME > Traitement des eaux usées > Hors infrastructure');
